...
class SMABacktester():
    ...
    ## Function for re-set the SMA's parameter        
    ...
    ## Function for plot the result (the cumelative return over the time)
    ...
    ## Function for finding the optimal SMA's parameters    
    def optimize_parameters(self, SMA_S_range, SMA_L_range):
        ...
        # get all possible combination of SMAs
